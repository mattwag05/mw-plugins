---
name: doc-navigator
description: Use when the user asks to "check the docs", "look up in docs", "what does the documentation say", "find in the docs", references a known harvested documentation set by name, or needs to navigate previously harvested documentation stored in the Claude Context Library.
metadata:
  version: "1.0.0"
---

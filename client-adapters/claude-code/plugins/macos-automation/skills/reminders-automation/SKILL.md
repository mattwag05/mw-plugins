...
|---------|-------------|--------------------------|
| List reminder lists | Yes Yes | Yes Yes |
| Read reminders | No No | Yes Yes |
| Create reminders | No No | Yes Yes |
| Update reminders | No No | Yes Yes |
| Mark complete | No No | Yes Yes |
| Due dates | No No | Yes Yes |
| Priorities | No No | Yes Yes |

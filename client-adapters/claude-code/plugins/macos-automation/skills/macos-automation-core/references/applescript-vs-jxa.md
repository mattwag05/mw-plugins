...
Yes Building TypeScript/Bun applications
Yes Need JSON output for parsing
Yes Familiar with JavaScript
Yes Want type-safe integration
Yes Creating new automations from scratch

### Use AppleScript when:

Yes Adapting existing AppleScript code
Yes Following Apple documentation examples
Yes Prefer natural language syntax
Yes Working with AppleScript-only resources
Yes Need extensive documentation

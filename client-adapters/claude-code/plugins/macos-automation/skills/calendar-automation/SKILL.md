...
description: Use when the user asks to "automate Calendar", "read calendar events", "create calendar events", "check today's schedule", "find meetings", "add appointments", "access calendars programmatically", or mentions Calendar.app automation, event scripting, or macOS calendar workflows.
metadata:
  version: "1.0.0"
---
...
|----------|------------|-------------|
| Reading | Access calendars, read events, check properties | Yes Full |
| Creating | Create events, set times, add attendees | Yes Full |
| Updating | Modify events, change times, update details | Yes Full |
| Searching | Filter by date, calendar, title | Yes Full |
| Calendars | List calendars, access properties | Yes Full |
...
- No Alarms with sound
- No Some attendee operations
